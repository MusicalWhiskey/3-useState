...
function App() {
  ...
  function handleAddToArray(){
    ...
    // we are trying to update the exArr state variable with the excat same reference as the previous. React compares the two reference, sees that they're the same. Therefore does not re-render the component.s
    // setExArr(updateArr)
